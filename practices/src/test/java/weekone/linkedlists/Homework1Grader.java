...
public class Homework1Grader {
    public static void main(final String[] array) {
        final Result runClasses =
                JUnitCore.runClasses(ContainsTest.class, InsertSortedTest.class, RemoveMaximumValuesTest.class);
        ...
        if (failureCount == 0) {
            ...
            for (final Failure failure : runClasses.getFailures()) {
                if (failure.getMessage() == null) {
                    ...
                    System.out.println("#" + k + ". " + failure.getException() + " occurs at " +
