...
public class RandomizedMazeGameTest {
    ...
    public void setUp() throws Exception {
        try {
            this.c = Class.forName("weekfour.uml.RandomizedMazeGame");
    ...
    public void testRandomizeMethod() {
        if (!MasterTester7.hasMethod(this.c, "randomize", Maze.class, Integer.TYPE)) {
            Assert.fail(
                    "RandomizedMazeGame should have a \"randomize\" method that accepts an int parameter and returns a Maze object");
        }
    }
}
